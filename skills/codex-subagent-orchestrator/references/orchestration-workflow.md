...
Use `../agent-skills-integration/agent-skill-routing.md` whenever a worker or stage needs vendored execution-discipline skills from `vendor/agent-skills/`.
...
1. write down the active judgment criteria for this stage or worker:
   ...
   - review burdens
2. pick the role core from `../agent-skills-integration/agent-skill-routing.md`
...
2. if yes, write the approved fix scope into `status.md` or `acceptance.md`
