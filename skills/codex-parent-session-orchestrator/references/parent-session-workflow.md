...
When the active phase needs stronger execution discipline, route into `../agent-skills-integration/agent-skill-routing.md` and open only the vendored upstream skills needed for that phase.
